...
<section class="body">
    ...
    <div class="inner-wrapper">
        ...
        <section role="main" class="content-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form id="form" <?php echo ("action=/faq/update/" . $faq->id) ?> method="POST" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        <section class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group row pb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="{{ old('faq', $faq->pertanyaan) }}" type="text" name="pertanyaan" class="form-control" placeholder="Pertanyaan" required />
                                    </div>
                                </div>
                                <div class="form-group row pb-3">
                                    <label class="col-sm-3 control-label text-lg-end pt-2" for="textareaDefault">Jawaban <span class="required">*</span></label>
                                    <div class="col-sm-9">
                                        <textarea name="jawaban" class="form-control" rows="3" required placeholder="Jawaban">{{$faq->jawaban}}</textarea>
                                    </div>
                                </div>
                            </div>
