                                ...
                                <div class="form-group row pb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group">
                                            ...
                                            <input value="{{ old('jam_mulai', $jadwal->jam_mulai) }}" type="text" name="jam_mulai" data-plugin-timepicker data-plugin-options='{ "showMeridian": false }' class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row pb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group">
                                            ...
                                            <input value="{{ old('jam_selesai', $jadwal->jam_selesai) }}" type="text" name="jam_selesai" data-plugin-timepicker data-plugin-options='{ "showMeridian": false }' class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
