    ...
    <section class="body">
        ...
        <header class="header header-nav-menu header-nav-links">
            <div class="logo-container">
                <a href="../" class="logo">
                    <img src="/img/Logo MTQ White.png" class="logo-image" width="90" height="50" alt="Porto Admin" />
                    <img src="/img/Logo MTQ White.png" class="logo-image-mobile" width="90" height="41" alt="Porto Admin" />
                </a>
