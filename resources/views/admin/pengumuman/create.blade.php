...
<section class="body">
    ...
    <div class="inner-wrapper">
        ...
        <section role="main" class="content-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form id="form" action="{{ route('admin-pengumuman-store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        <section class="card">
                                ...
                                <div class="form-group row pb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="switch switch-sm switch-info">
                                            <input type="checkbox" name="is_featured" data-plugin-ios-switch />
                                        </div>
                                    </div>
                                </div>
                            </div>
