                    ...
                    <form class="contact-form" action="{{ route('pesan-store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" value="" data-msg-required="Tolong masukan nama Anda." maxlength="100" class="form-control text-3 h-auto py-2" name="nama" required>
                            </div>
                            <div class="form-group col-lg-6">
                        ...
                        <div class="row">
                            <div class="form-group col">
                                ...
                                <input type="text" value="" data-msg-required="Tolong masukan judul pesan." maxlength="100" class="form-control text-3 h-auto py-2" name="judul" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col">
                                <label class="form-label mb-1 text-2">Pesan</label>
                                <textarea maxlength="5000" data-msg-required="Tolong masukan pesan Anda." rows="8" class="form-control text-3 h-auto py-2" name="isi" required></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col">
