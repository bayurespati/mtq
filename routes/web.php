...
Route::get('/artikel/berita/example/{berita}', [FrontViewController::class, 'beritaExample'])->name('berita-example');
Route::get('/artikel/pengumuman', [FrontViewController::class, 'pengumuman'])->name('pengumuman');
Route::get('/artikel/pengumuman/example/{pengumuman}', [FrontViewController::class, 'pengumumanExample'])->name('pengumuman-example');
